...
export default function Navbar() {
  ...
  return (
    <>
      ...
      {/* Sticky mobile CTA — visible only on small screens, hidden once at contact section */}
      <motion.div
        initial={{ y: 80, opacity: 0 }}
        animate={{ y: 0, opacity: 1 }}
      ...
      >
        <div className="border-t border-white/10 bg-navy-deep/95 px-4 py-3 backdrop-blur-md">
          <a
            href="#contact"
            className="flex w-full items-center justify-center gap-2 rounded-sm bg-gold py-3.5 text-[13px] font-semibold uppercase tracking-[0.12em] text-navy transition-all duration-200 active:bg-gold-light"
          >
